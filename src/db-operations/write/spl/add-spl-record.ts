	...
	try {
		...
		const addSPLResponse = await prismaClient.spl.create({
			data: {
				...
				listing_price_per_share_usd: newSPLData.listingSharePriceUsd,
				...
				instant_access_price_to_exclusive_content_usd: newSPLData.instantAccessPriceToExclusiveContentUsd,
