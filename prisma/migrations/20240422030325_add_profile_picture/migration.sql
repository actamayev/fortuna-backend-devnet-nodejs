...
*/
-- AlterTable
ALTER TABLE "credentials" ADD COLUMN     "profile_picture_id" INTEGER;
...
-- CreateIndex
CREATE UNIQUE INDEX "profile_picture_profile_picture_id_key" ON "profile_picture"("profile_picture_id");
